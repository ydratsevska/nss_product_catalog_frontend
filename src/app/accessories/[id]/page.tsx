...
export default function Page({ params }: { params: {id: string}}) {
  ...
  const onColorChange = (newColor: string) => {
    const product = data
      .current
      ?.variants
      .find(({ color, capacity}) => color === newColor && capacity === selectedProduct?.capacity);
  ...
  const onCapacityChange = (newCapacity: string) => {
    const product = data
      .current
      ?.variants
      .find(({ color, capacity}) => (color === selectedProduct?.color && capacity === newCapacity))
